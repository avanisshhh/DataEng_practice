...
--Stored Procedure is a precompiled set of SQL statements stored in the database that can be executed with parameters for reusable and efficient data operations.