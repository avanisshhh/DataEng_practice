...
--SUBSTRING(string, start, length) returns a substring of the specified string starting from the position defined by 'start' and with the length defined by 'length'. In this case, it will return 'LLO' because it starts from the 2nd character of 'HELLO' and takes the next 3 characters.
SELECT EnglishProductName,
