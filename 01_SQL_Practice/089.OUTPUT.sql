...
'''
It returns the rows immediately after they are inserted.
“It allows capturing affected rows during INSERT, UPDATE, DELETE without running a separate query.”
'''
...
--This creates a table variable (temporary in-memory table) 
